...
class TestZeroSteps1 {
    ...
    public void testSum() {
        ...
        Assertions.assertEquals(4, zeroSteps1.sum(2, 2));
        Assertions.assertEquals(20000, zeroSteps1.sum(10000, 10000));
    }

    @Test
    public void testMul() {
        ZeroSteps1 zeroSteps1 = new ZeroSteps1();
        Assertions.assertEquals(4, zeroSteps1.mul(2, 2));
        Assertions.assertEquals(100000000, zeroSteps1.mul(10000, 10000));
    }

    @Test
    public void testDiv() {
        ZeroSteps1 zeroSteps1 = new ZeroSteps1();
        Assertions.assertEquals(1, zeroSteps1.div(2, 2));
        Assertions.assertEquals(0, zeroSteps1.div(1, 2));
        Assertions.assertEquals(1, zeroSteps1.div(10200, 10000));
    }

    @Test
    public void testMod() {
        ZeroSteps1 zeroSteps1 = new ZeroSteps1();
        Assertions.assertEquals(1, zeroSteps1.mod(3, 2));
        Assertions.assertEquals(0, zeroSteps1.mod(4, 2));
        Assertions.assertEquals(10, zeroSteps1.mod(70, 20));
    }

    @Test
    public void testEquals() {
        ZeroSteps1 zeroSteps1 = new ZeroSteps1();
        Assertions.assertTrue(zeroSteps1.isEqual(2, 2));
        Assertions.assertFalse(zeroSteps1.isEqual(3, 2));
    }

    @Test
    public void testGreater() {
        ZeroSteps1 zeroSteps1 = new ZeroSteps1();
        Assertions.assertTrue(zeroSteps1.isGreater(3, 2));
        Assertions.assertFalse(zeroSteps1.isGreater(2, 2));
        Assertions.assertFalse(zeroSteps1.isGreater(1, 2));
    }

    @Test
    public void testCalculateTriangleSquare() {
        ZeroSteps1 zeroSteps1 = new ZeroSteps1();
        Assertions.assertEquals(6, zeroSteps1.calculateTriangleSquare(3, 4), DOUBLE_EPS);
        Assertions.assertEquals(7.5, zeroSteps1.calculateTriangleSquare(3, 5), DOUBLE_EPS);
    }

   @Test
    public void testCalculateTrianglePerimeter() {
        ZeroSteps1 zeroSteps1 = new ZeroSteps1();
        Assertions.assertEquals(12, zeroSteps1.calculateTrianglePerimeter(3, 4), DOUBLE_EPS);
        Assertions.assertEquals(13.830952, zeroSteps1.calculateTrianglePerimeter(3, 5), DOUBLE_EPS);
    }
    ...
    public void testIsInsideRect() {
        ...
        Assertions.assertFalse(zeroSteps1.isInsideRect(0, 0, 100, 100, 0, -1));
    }
    ...
    public void testSqrtAbs() {
        ZeroSteps1 zeroSteps1 = new ZeroSteps1();
        Assertions.assertEquals(100, zeroSteps1.sqrtAbs(10000));
        Assertions.assertEquals(100, zeroSteps1.sqrtAbs(-10000));
        Assertions.assertEquals(0, zeroSteps1.sqrtAbs(0));
    }
